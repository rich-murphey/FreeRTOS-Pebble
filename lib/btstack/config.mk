# CFLAGS_bt = $(CFLAGS_stm32f4xx)
# CFLAGS_bt += $(CFLAGS_driver_stm32_buttons)
# CFLAGS_bt += $(CFLAGS_driver_stm32_power)
...
# SRCS_bt = $(SRCS_stm32f4xx)
# SRCS_bt += $(SRCS_driver_stm32_buttons)
# SRCS_bt += $(SRCS_driver_stm32_power)
# SRCS_bt += lib/btstack/btstack/*.c

SRCS_bt += lib/btstack/btstack_rebble.c
SRCS_bt += lib/btstack/gap_inquiry.c
...
SRCS_bt += lib/btstack/btstack/src/classic/btstack_sbc_bludroid.c
